...
long b = 0;             //
const int PinR1 = 4;    //  arduino  pin 5 to l298  pin IN4
const int PinR2 = 5;    //  arduino  pin 6 to l298  pin IN3
...
const int PwmL  = 11;   //  arduino  pin 10 to l298  pin ENA
//****************************************************************************************************************************************************
...
// load and configure the DMP
 ...
 //  use calibration program to get your own values
    mpu.setXGyroOffset(120);//(220);
    mpu.setYGyroOffset(40);//(76);
    mpu.setZGyroOffset(-85);//(-85);
    mpu.setXAccelOffset(1688);//(1788); // 1688 factory default for my test chip
